# M4 PR4 M3 Version Gate Update

## Problema

Il test M3 verificava ancora rigidamente `0.3.0-beta.1`, bloccando la progressione corretta della milestone M4 a `0.4.0-alpha.4`.
